...
static const struct tegra_emc_chip picasso_elpida_300mhz_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = 0x5454,
		.table = picasso_emc_tables_elpida_300Mhz,
		.table_size = ARRAY_SIZE(picasso_emc_tables_elpida_300Mhz)
	},
};

int __init picasso_emc_init(void)
{
...
//				ARRAY_SIZE(picasso_emc_tables_Hynix_8Gb_300Mhz));
	...
	tegra_init_emc(picasso_elpida_300mhz_emc_chips, ARRAY_SIZE(picasso_elpida_300mhz_emc_chips));
