...
#define PICASSO_GPIO_WM8903(_x_)	(PICASSO_WM8903_GPIO_BASE + (_x_))
#define PICASSO_GPIO_WM8903_END		PICASSO_GPIO_WM8903(4)

/* Audio-related GPIOs */
#define TEGRA_GPIO_CDC_IRQ			TEGRA_GPIO_PX3
#ifdef CONFIG_MACH_VANGOGH
#define TEGRA_GPIO_SPKR_EN			PICASSO_GPIO_WM8903(0)
#define TEGRA_GPIO_SPKR_MUTE		PICASSO_GPIO_WM8903(2)
#else
