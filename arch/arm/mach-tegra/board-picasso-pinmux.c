/*
 * arch/arm/mach-tegra/board-picasso-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config picasso_drive_pinmux[] = {
	DEFAULT_DRIVE(VI1),
	DEFAULT_DRIVE(SDIO1),
...
static __initdata struct tegra_pingroup_config picasso_pinmux[] = {
...
int __init picasso_pinmux_init(void)
{
	tegra_pinmux_config_table(picasso_pinmux, ARRAY_SIZE(picasso_pinmux));
	tegra_drive_pinmux_config_table(picasso_drive_pinmux,
					ARRAY_SIZE(picasso_drive_pinmux));
